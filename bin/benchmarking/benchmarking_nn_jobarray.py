...
if __name__ == '__main__': 
    ...
    test_set = pickle.load(open(
        '/groups/rgutenk/lnt/projects/ml-dadi/data/benchmarking_nn/benchmarking_test_set_1','rb'))
    ...
    if process_id >= 40:    
        print('Optimization time for dadi + 4_RFR_avg: {0:.2f}s'.format(end),
                                                                        '\n')
    # run scripts from '/groups/rgutenk/lnt/projects/ml-dadi/results/2d-splitmig/benchmarking_nn/jobarray'