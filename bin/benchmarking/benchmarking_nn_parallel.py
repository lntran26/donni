...
if __name__ == '__main__': 
    test_set = pickle.load(open('/groups/rgutenk/lnt/projects/ml-dadi/data/benchmarking_nn/benchmarking_test_set_1','rb'))
    ...
    pickle.dump(results_list, open('benchmarking_results_nn_1', 'wb'), 2)
    # run scripts from '/groups/rgutenk/lnt/projects/ml-dadi/results/2d-splitmig/benchmarking_nn/parallel'