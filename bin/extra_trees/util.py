...
if __name__ == "__main__":
    ...
    # train rfr
    rfr = vrfr_train(transformed_list_train_dict[0], -1)
    # test rfr
    y_true, y_predict = vrfr_test(rfr, list_test_dict[0])
    print(y_predict)
